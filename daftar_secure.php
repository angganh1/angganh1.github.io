...
<title>Pendaftaran Secure</title>
...
<h1><a href="index_secure.php"><button class= "btn btn-primary"><i class="fa-sharp fa-solid fa-right-from-bracket"></i></button></a></h1>
...
<div align="center">
<div style="border:2;padding:1px;width:450px;height:330px;border-radius:30px;background-color:rgba(0, 140, 255, 0.445);">

            <form action="kirim_secure.php" method="post">
