...
<br>
    ...
    <div align="center">
        <div style="border:2;padding:1px;width:450px;height:450px;border-radius:30px;background-color:rgba(223, 0, 0, 0.534);">

        <form action="kirim_anggota.php" method="post" enctype="multipart/form-data">
        <div class="ak">
            ...
            <input class="form-control form-control-md" required type="text" name="nim" placeholder="Masukkan NIM Anda">
            ...
            <br>
            <button class="btn btn-danger" type="submit" value="Tambahkan">Tambahkan</button>
        </div>
        </form>
    </div>
